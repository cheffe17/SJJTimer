                ...
                <form wire:submit="save" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" wire:model="location" placeholder="z.B. Wien, Berlin, München"
                                class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all duration-200 text-gray-700 placeholder-gray-400" />
                        </div>
                    </div>
