                ...
                >
                    ...
                    @if($isStayActive && $location)
                        <div class="text-center mb-5">
                            <div class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200">
                    ...
                    <div x-show="!finished" class="grid grid-cols-4 gap-3 mb-5">
                        ...
                        <div class="text-center">
                            <div class="bg-gradient-to-b {{ $isStayActive ? 'from-green-700 to-green-900' : 'from-slate-800 to-slate-900' }} rounded-2xl p-3 shadow-lg {{ $var === 'seconds' ? 'relative overflow-hidden' : '' }}">
                                <span x-text="String({{ $var }}).padStart(2, '0')" class="text-3xl sm:text-4xl font-extrabold text-white font-mono tracking-wider {{ $var === 'seconds' ? 'relative z-10' : '' }}"></span>
                                @if($var === 'seconds')
            ...
            @elseif($nextEvent)
                ...
                >
                    ...
                    <div class="text-center mb-6">
                        ...
                        @if($nextEventLocation)
                            <p class="text-sm text-gray-600 mt-2 font-medium">
                                <svg class="w-4 h-4 inline-block text-gray-400 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="!passed" class="grid grid-cols-4 gap-3 mb-4">
                        @foreach(['days' => 'Tage', 'hours' => 'Stunden', 'minutes' => 'Minuten', 'seconds' => 'Sekunden'] as $var => $label)
                        <div class="text-center">
                            <div class="bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl p-3 sm:p-4 shadow-lg shadow-slate-300/30 {{ $var === 'seconds' ? 'relative overflow-hidden' : '' }}">
                                <span x-text="String({{ $var }}).padStart(2, '0')" class="text-3xl sm:text-4xl font-extrabold text-white font-mono tracking-wider {{ $var === 'seconds' ? 'relative z-10' : '' }}"></span>
                                @if($var === 'seconds')
